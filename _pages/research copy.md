...
<sup> <i>Advisor:  Dr. Alyssa Goodman <br> Smithsonian Astrophysical Observatory REU Program </i> </sup> 

We've created a map of magnetic fields over the surface of the Local Bubble, which is the first map of its kind to fully map magnetic fields in 3-D over an observed superbubble.

<blockquote class="embedly-card" data-card-align="left" data-card-width="45%"><h4><a href="https://youtu.be/tptUMW4GMcM">null</a></h4><p>null</p></blockquote>
...
## Identifying Pre-main-sequence Stars using Machine Learning
<sup> <i>Advisor:  Dr. Remy Indebetouw <br> UVA Senior Thesis  </i> </sup> 

I'm currently developing methods to identify pre-main sequence (PMS) stars in HST photometry using unsupervised machine learning methods.  We are applying these methods to the Large Magellanic Cloud star-forming region N159.
